      ...
      <div className="flex flex-col items-center w-full max-w-6xl px-4 py-8">
        <div className="w-full flex flex-row rounded-2xl border border-yellow-100 bg-white shadow-2xl overflow-hidden h-[680px]">
          ...
          <div className="flex-1 flex flex-col justify-center px-8 py-2 md:px-10 md:py-4 lg:px-12 lg:py-6">
            <h2 className="text-3xl font-bold text-center mb-6 mt-2">Step into your space. Register with Libyte today.</h2>
            <form className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 mt-2">
              ...
              <div className="col-span-1">
                <label className="block text-base font-semibold mb-1" htmlFor="email">Username:</label>
                <input id="email" type="email" placeholder="Enter your Username" className="w-full border-2 border-yellow-800 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-base" />
              </div>

              <div className="col-span-1 md:col-span-2">
                <label className="block text-base font-semibold mb-1" htmlFor="contact">Email Address:</label>
                <input id="contact" type="text" placeholder="Enter your Email Address" className="w-full border-2 border-yellow-800 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-base" />
              </div>

              <div className="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 w-full mt-2">
                <div>
              ...
              <div className="col-span-1 md:col-span-2 flex flex-col items-center mt-10">
                ...
                <div className="flex items-center justify-center gap-2 mt-5">
                  ...
                  <button
                    ...
                    onClick={() => window.location.href = '/librarian-login'}
                  >
                    Login
                  </button>
                </div>
